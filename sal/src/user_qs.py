...
1. For each opportunity you deem relevant, you write 3 concise sentences solely based on the information in the context, that explain the following. Make sure every single opportunity you found you write these for - they CANNOT be blank.
